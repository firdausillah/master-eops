                                            ...
                                            <div class="col-12">
                                                <div class="card">
                                                    <div class="card-block">
                                                        <form action="<?= base_url('admin/kelas_siswa/tambah') ?>" method="GET">
                                                            <div class="row">
                                                                <div class="col-lg-6">
                                                                ...
                                                                <div class="col-lg-2">
                                                                    <div style="margin-top:25px;">
                                                                        <button type="submit" class="btn btn-info btn-sm btn-block">Siswa Dengan Kelas</button>
                                                                    </div>
                                                                </div>
                                                                <div class="col-lg-2">
                                                                    <div style="margin-top:25px;">
                                                                        <button type="submit" class="btn btn-info btn-sm btn-block">Siswa Tanpa Kelas</button>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                        </form>
