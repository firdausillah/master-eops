                                                                ...
                                                                <tbody>
                                                                    <?php foreach ($kelas as $no => $kls) : ?>
                                                                        <tr>
                                                                            ...
                                                                            <td><?= $kls->kelas ?></td>
                                                                            <td style="width: 20%;">
                                                                                <a href="<?= base_url('admin/kelas/edit/' . $kls->id) ?>" class="btn btn-info btn-small"><i class="ti-pencil-alt"></i></a>
                                                                                <a href="<?= base_url('admin/kelas/delete/' . $kls->id) ?>" class="btn btn-danger btn-small tombol-hapus"><i class="ti-trash"></i></a>
                                                                            </td>
                                                                        </tr>
                                                                    <?php endforeach ?>
                                                                </tbody>
                    ...
                    <div class="modal fade" id="exampleModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                        <div class="modal-dialog" role="document">
                            <div class="modal-content">
                                ...
                                <?= form_open_multipart('admin/kelas/save') ?>
